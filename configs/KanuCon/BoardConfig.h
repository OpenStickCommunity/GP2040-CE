...
#define PIN_BUTTON_B1   22          // B1 / A / B / Cross / 2 / K1
#define PIN_BUTTON_B2   16          // B2 / B / A / Circle / 3 / K2
#define PIN_BUTTON_R2   4           // R2 / RT / ZR / R2 / 8 / K3
#define PIN_BUTTON_L2   3           // L2 / LT / ZL / L2 / 7 / K4
#define PIN_BUTTON_B3   23          // B3 / X / Y / Square / 1 / P1
#define PIN_BUTTON_B4   12          // B4 / Y / X / Triangle / 4 / P2
...
#define PIN_BUTTON_S2   21          // S2 / Start / Plus / Start / 10 / Start
...
#define PIN_BUTTON_A2   7           // A2 / ~ / Capture / ~ / 14 / ~
...
#define DEFAULT_INPUT_MODE INPUT_MODE_SWITCH //INPUT_MODE_XINPUT (XInput), INPUT_MODE_SWITCH (Nintendo Switch), INPUT_MODE_HID (D-Input), INPUT_MODE_KEYBOARD (Keyboard)
...
#define PIN_TILT_LEFT_ANALOG_UP 9
#define PIN_TILT_LEFT_ANALOG_DOWN 18
#define PIN_TILT_LEFT_ANALOG_LEFT 19
#define PIN_TILT_LEFT_ANALOG_RIGHT 17
#define PIN_TILT_RIGHT_ANALOG_UP 11
#define PIN_TILT_RIGHT_ANALOG_DOWN 6
#define PIN_TILT_RIGHT_ANALOG_LEFT 8
#define PIN_TILT_RIGHT_ANALOG_RIGHT 5
