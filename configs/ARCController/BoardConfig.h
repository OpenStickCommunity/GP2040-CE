...
#define BOARD_CONFIG_LABEL "ARC Accessibility Controller"
...
0,  1, 2,  3, 4,  LightType::LightType_ActionButton, \
1,  1, 4,  3, 3,  LightType::LightType_ActionButton, \
2,  1, 6,  4, 5,  LightType::LightType_ActionButton, \
3,  1, 7,  7, 2,  LightType::LightType_ActionButton, \
4,  1, 8,  3, 6,  LightType::LightType_ActionButton, \
5,  1, 10, 2, 7,  LightType::LightType_ActionButton, \
6,  1, 12, 2, 8,  LightType::LightType_ActionButton, \
7,  1, 14, 2, 9,  LightType::LightType_ActionButton, \
8,  1, 8,  5, 10, LightType::LightType_ActionButton, \
9,  1, 10, 4, 11, LightType::LightType_ActionButton, \
10, 1, 12, 4, 12, LightType::LightType_ActionButton, \
11, 1, 14, 4, 13, LightType::LightType_ActionButton
