# GP2040 Configuration for Raspberry Pi Pico 2

![Pin Mapping](assets/PinMapping.png)

Basic pin setup for a stock Raspberry Pi Pico 2. Combine with a simple GPIO breakout/screw terminal board for an easy DIY arcade stick.
