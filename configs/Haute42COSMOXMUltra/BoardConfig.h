...
#define DEFAULT_BOARD_LAYOUT_A_ALT3 {\
    ...
    {GP_ELEMENT_PIN_BUTTON, {32, 27, 4, 4, 1, 1, 3, GP_SHAPE_ELLIPSE}},\
    {GP_ELEMENT_PIN_BUTTON, {40, 32, 4, 4, 1, 1, 4, GP_SHAPE_ELLIPSE}},\
    {GP_ELEMENT_PIN_BUTTON, {68, 15, 2, 2, 1, 1, 14, GP_SHAPE_ELLIPSE}},\
    {GP_ELEMENT_PIN_BUTTON, {75, 15, 2, 2, 1, 1, 18, GP_SHAPE_ELLIPSE}},\
    {GP_ELEMENT_PIN_BUTTON, {82, 15, 2, 2, 1, 1, 19, GP_SHAPE_ELLIPSE}},\
    {GP_ELEMENT_PIN_BUTTON, {89, 15, 2, 2, 1, 1, 20, GP_SHAPE_ELLIPSE}},\
    {GP_ELEMENT_PIN_BUTTON, {96, 15, 2, 2, 1, 1, 16, GP_SHAPE_ELLIPSE}},\
    {GP_ELEMENT_PIN_BUTTON, {44, 49, 5, 5, 1, 1, 27, GP_SHAPE_ELLIPSE}},\
...
#define DEFAULT_BOARD_LAYOUT_B_ALT3 {\
    ...
    {GP_ELEMENT_PIN_BUTTON, {57, 49, 5, 5, 1, 1, 26, GP_SHAPE_ELLIPSE}},\
}
...
#define DEFAULT_BOARD_LAYOUT_A_ALT4 {\
    ...
    {GP_ELEMENT_PIN_BUTTON, {32, 17, 39, 24, 1, 1, 2, GP_SHAPE_SQUARE,22}},\
    {GP_ELEMENT_PIN_BUTTON, {36, 29, 43, 36, 1, 1, 4, GP_SHAPE_SQUARE,22}},\
    {GP_ELEMENT_PIN_BUTTON, {68, 15, 2, 2, 1, 1, 14, GP_SHAPE_ELLIPSE}},\
    {GP_ELEMENT_PIN_BUTTON, {75, 15, 2, 2, 1, 1, 18, GP_SHAPE_ELLIPSE}},\
    {GP_ELEMENT_PIN_BUTTON, {82, 15, 2, 2, 1, 1, 19, GP_SHAPE_ELLIPSE}},\
    {GP_ELEMENT_PIN_BUTTON, {89, 15, 2, 2, 1, 1, 20, GP_SHAPE_ELLIPSE}},\
...
16, 1,  8,  0, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
17, 1,  6,  0, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
18, 1,  4,  0, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
19, 1,  2,  0, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
20, 1,  0,  0, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
21, 1,  0,  2, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
22, 1,  0,  4, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
23, 1,  0,  6, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
24, 1,  0,  8, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
25, 1,  0, 10, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
26, 1,  0, 12, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
27, 1,  2, 12, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
28, 1,  4, 12, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
29, 1,  6, 12, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
30, 1,  8, 12, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
31, 1, 10, 12, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
32, 1, 12, 12, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
33, 1, 14, 12, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
34, 1, 16, 12, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
35, 1, 18, 12, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
36, 1, 18, 10, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
37, 1, 18,  8, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
38, 1, 18,  6, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
39, 1, 18,  4, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
40, 1, 18,  2, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
41, 1, 18,  0, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
42, 1, 16,  0, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
43, 1, 14,  0, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
44, 1, 12,  0, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case, \
45, 1, 10,  0, LEDS_STATIC_COLOR_CASE, LightType::LightType_Case
