...
#define PIN_DPAD_UP           10   // UP
#define PIN_DPAD_DOWN         11   // DOWN
...
#define PIN_SLIDER_ONE        26   // Left Stick Slider
#define PIN_SLIDER_TWO        25   // Right Stick Slider
#define PIN_SLIDER_SOCD_ONE   24   // SOCD Slider Pin One
#define PIN_SLIDER_SOCD_TWO   23   // SOCD Slider Pin Two
