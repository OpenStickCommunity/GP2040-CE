...
#ifndef VENOMEZ_CONFIG_H_
#define VENOMEZ_CONFIG_H_

#include "enums.pb.h"

#define BOARD_CONFIG_LABEL "VenomEZ"

// Main pin mapping Configuration
//                          // GP2040 | Xinput | Switch  | PS3/4/5  | Dinput | Arcade |
#define GPIO_PIN_17 GpioAction::BUTTON_PRESS_UP		 // UP     | UP     | UP      | UP       | UP     | UP     |
#define GPIO_PIN_16 GpioAction::BUTTON_PRESS_DOWN	 // DOWN   | DOWN   | DOWN    | DOWN     | DOWN   | DOWN   |
...
#define GPIO_PIN_09 GpioAction::BUTTON_PRESS_A1 // A1     | Guide  | Home    | PS       | 13     | ~      |
...
#define GPIO_PIN_21 GpioAction::BUTTON_PRESS_TURBO

#define JSLIDER_ENABLED 1
#define GPIO_PIN_22 GpioAction::SUSTAIN_DP_MODE_DP
// #define GPIO_PIN_22 GpioAction::SUSTAIN_DP_MODE_RS
#define SLIDER_MODE_ZERO DPAD_MODE_LEFT_ANALOG

#define SLIDER_SOCD_ENABLED 0
// #define GPIO_PIN_XX GpioAction::SUSTAIN_SOCD_MODE_UP_PRIO
// #define GPIO_PIN_XX GpioAction::SUSTAIN_SOCD_MODE_SECOND_WIN
// #define SLIDER_SOCD_SLOT_DEFAULT SOCD_MODE_NEUTRAL

#define DEFAULT_PS4CONTROLLER_TYPE PS4_ARCADESTICK

#define DEFAULT_INPUT_MODE_R1 INPUT_MODE_XINPUT
