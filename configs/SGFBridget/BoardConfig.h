 ...
 * SPDX-FileCopyrightText: Copyright (c) 2023 SGF Devices
 */

#ifndef SGF_BRIDGET_CONFIG_H_
#define SGF_BRIDGET_CONFIG_H_

#include <GamepadEnums.h>
// Mapping between switch number (as silkscreened) and GPIO pin

#define BRIDGET_SW1_PIN    6
#define BRIDGET_SW2_PIN    5
#define BRIDGET_SW3_PIN    4
#define BRIDGET_SW4_PIN    3
#define BRIDGET_SW5_PIN    2
#define BRIDGET_SW6_PIN    1
#define BRIDGET_SW7_PIN    9  // LEFT
#define BRIDGET_SW8_PIN    10 // DOWN
#define BRIDGET_SW9_PIN    11 // RIGHT
#define BRIDGET_SW10_PIN   18 // P1 / SQUARE
#define BRIDGET_SW11_PIN   25 // P2 / TRIANGLE
#define BRIDGET_SW12_PIN   27 // P3
#define BRIDGET_SW13_PIN   29 // P4
#define BRIDGET_SW14_PIN   19 // K1 / CROSS
#define BRIDGET_SW15_PIN   24 // K2 / CIRCLE
#define BRIDGET_SW16_PIN   26 // K3
#define BRIDGET_SW17_PIN   28 // K4
#define BRIDGET_SW18_PIN   16 // UP / THUMB
...
#define PIN_DPAD_UP     BRIDGET_SW18_PIN         // DOWN
#define PIN_DPAD_DOWN   BRIDGET_SW8_PIN          // UP
#define PIN_DPAD_RIGHT  BRIDGET_SW9_PIN          // RIGHT
#define PIN_DPAD_LEFT   BRIDGET_SW7_PIN          // LEFT
#define PIN_BUTTON_B1   BRIDGET_SW14_PIN         // B1 / A / B / Cross / 2 / K1
#define PIN_BUTTON_B2   BRIDGET_SW15_PIN         // B2 / B / A / Circle / 3 / K2
#define PIN_BUTTON_R2   BRIDGET_SW16_PIN         // R2 / RT / ZR / R2 / 8 / K3
#define PIN_BUTTON_L2   BRIDGET_SW17_PIN         // L2 / LT / ZL / L2 / 7 / K4
#define PIN_BUTTON_B3   BRIDGET_SW10_PIN         // B3 / X / Y / Square / 1 / P1
#define PIN_BUTTON_B4   BRIDGET_SW11_PIN         // B4 / Y / X / Triangle / 4 / P2
#define PIN_BUTTON_R1   BRIDGET_SW12_PIN         // R1 / RB / R / R1 / 6 / P3
#define PIN_BUTTON_L1   BRIDGET_SW13_PIN         // L1 / LB / L / L1 / 5 / P4
#define PIN_BUTTON_S1   BRIDGET_SW2_PIN          // S1 / Back / Minus / Select / 9 / Coin
#define PIN_BUTTON_S2   BRIDGET_SW1_PIN          // S2 / Start / Plus / Start / 10 / Start
#define PIN_BUTTON_L3   BRIDGET_SW5_PIN          // L3 / LS / LS / L3 / 11 / LS
#define PIN_BUTTON_R3   BRIDGET_SW6_PIN          // R3 / RS / RS / R3 / 12 / RS
#define PIN_BUTTON_A1   BRIDGET_SW3_PIN          // A1 / Guide / Home / PS / 13 / ~
#define PIN_BUTTON_A2   BRIDGET_SW4_PIN          // A2 / ~ / Capture / ~ / 14 / ~
