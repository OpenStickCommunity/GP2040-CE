...
![GP2040 Configurator - Add-Ons I2C Input Expansion](assets/images/gpc-add-ons-inputexpansion.png)

* `I2C Input Expansion SDA Pin` - The GPIO pin used for I2C Input Expansion SDA.
* `I2C Input Expansion SCL Pin` - The GPIO pin used for I2C Input Expansion SCL.
* `I2C Input Expansion Block` - The block of I2C to use (i2c0 or i2c1).
* `I2C Input Expansion Speed` - Sets the speed of I2C communication. The standard value of `100000`
should work for most hardware.
* `I2C Input Expansion Address` - The I2C address of the I2C Input Expansion.
* `I2C Input Expansion Analog Map` - Comma-separated list of analog inputs published by the I2C Input Expansion.
* `I2C Input Expansion Digital Map` - Comma-separated list of digital inputs published by the I2C Input Expansion.
