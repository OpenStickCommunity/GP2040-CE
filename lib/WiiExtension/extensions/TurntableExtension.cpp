...
void TurntableExtension::init(uint8_t dataType) {
    ...
    _analogPrecision[WiiAnalogs::WII_ANALOG_TRIGGER_LEFT].origin                     = WII_ANALOG_PRECISION_0; // 32
    _analogPrecision[WiiAnalogs::WII_ANALOG_TRIGGER_LEFT].destination                = WII_ANALOG_PRECISION_2;
    _analogPrecision[WiiAnalogs::WII_ANALOG_TRIGGER_RIGHT].origin                    = WII_ANALOG_PRECISION_0; // 32
    ...
    _analogCalibration[WiiAnalogs::WII_ANALOG_TRIGGER_LEFT].center     = WII_TURNTABLE_TRIGGER_MAX/2;
    _analogCalibration[WiiAnalogs::WII_ANALOG_TRIGGER_LEFT].maximum    = WII_TURNTABLE_TRIGGER_MAX;

    _analogCalibration[WiiAnalogs::WII_ANALOG_TRIGGER_RIGHT].minimum   = 1;
    _analogCalibration[WiiAnalogs::WII_ANALOG_TRIGGER_RIGHT].center    = WII_TURNTABLE_TRIGGER_MAX/2;
    _analogCalibration[WiiAnalogs::WII_ANALOG_TRIGGER_RIGHT].maximum   = WII_TURNTABLE_TRIGGER_MAX;
}
...
void TurntableExtension::process(uint8_t *inputData) {
    ...
    directionalPad[TurntableDirectionalPad::TURNTABLE_LEFT_GREEN]    = !((inputData[5] & 0x08) >> 3);
