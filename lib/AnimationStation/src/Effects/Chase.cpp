...
uint16_t Chase::defaultCycleTime = 80;

Chase::Chase(std::vector<Pixel> pixels)
    : Animation(pixels), cycleTime(Chase::defaultCycleTime) {}

Chase::Chase(std::vector<Pixel> pixels, uint16_t cycleTime)
