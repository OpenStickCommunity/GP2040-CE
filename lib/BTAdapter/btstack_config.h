...
#else
#define MAX_NR_GATT_CLIENTS 0 // std only
#endif

// BTstack configuration. buffers, sizes, ...
#define HCI_OUTGOING_PRE_BUFFER_SIZE 4 // both
#define HCI_ACL_PAYLOAD_SIZE (255 + 4) // (255 + 4) in std, (1691 + 4) in classic
...
#define HCI_HOST_ACL_PACKET_LEN (255+4) // (255+4) in std, 1024 in classic
