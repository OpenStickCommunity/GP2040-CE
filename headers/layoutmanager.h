...
class LayoutManager {
    ...
    private:
        ...
        std::map<uint16_t,LayoutFunction> GPButtonLayouts_LeftLayouts = {
            ...
            {BUTTON_LAYOUT_SUNGA12KEYA,               [this]() { return this->drawSunga12keyA(); }},
            {BUTTON_LAYOUT_SUNGA13KEYA,               [this]() { return this->drawSunga13keyA(); }},
            {BUTTON_LAYOUT_SUNGA14KEYLRA,             [this]() { return this->drawSunga14keyLRA(); }},
            {BUTTON_LAYOUT_SUNGA14KEYUDA,             [this]() { return this->drawSunga14keyUDA(); }},
            {BUTTON_LAYOUT_SUNGA17KEYA,               [this]() { return this->drawSunga17keyA(); }},
        ...
        std::map<uint16_t,LayoutFunction> GPButtonLayouts_RightLayouts = {
            ...
            {BUTTON_LAYOUT_SUNGA12KEYB,               [this]() { return this->drawSunga12keyB(); }},
            {BUTTON_LAYOUT_SUNGA13KEYB,               [this]() { return this->drawSunga13keyB(); }},
