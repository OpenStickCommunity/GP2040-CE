...
private:
	...
	void drawSunga12keyA(int startX, int startY, int buttonSize, int buttonPadding);
	void drawSunga12keyB(int startX, int startY, int buttonSize, int buttonPadding);
	void drawSunga13keyA(int startX, int startY, int buttonSize, int buttonPadding);
	void drawSunga13keyB(int startX, int startY, int buttonSize, int buttonPadding);
	void drawSunga14keyLRA(int startX, int startY, int buttonSize, int buttonPadding);
	void drawSunga14keyLRB(int startX, int startY, int buttonSize, int buttonPadding);
	void drawSunga14keyUDA(int startX, int startY, int buttonSize, int buttonPadding);
	void drawSunga14keyUDB(int startX, int startY, int buttonSize, int buttonPadding);
	void drawSunga17keyA(int startX, int startY, int buttonSize, int buttonPadding);
	void drawSunga17keyAAlt(int startX, int startY, int buttonSize, int buttonPadding);
