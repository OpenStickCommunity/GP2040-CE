...
struct LEDOptions
{
	...
	int indexA2;
	bool useCustomLeds;
	uint32_t customColorUp;
	uint32_t customColorDown;
	uint32_t customColorLeft;
	uint32_t customColorRight;
	uint32_t customColorB1;
	uint32_t customColorB2;
	uint32_t customColorB3;
	uint32_t customColorB4;
	uint32_t customColorL1;
	uint32_t customColorR1;
	uint32_t customColorL2;
	uint32_t customColorR2;
	uint32_t customColorS1;
	uint32_t customColorS2;
	uint32_t customColorL3;
	uint32_t customColorR3;
	uint32_t customColorA1;
	uint32_t customColorA2;
	uint32_t customColorUpPressed;
	uint32_t customColorDownPressed;
	uint32_t customColorLeftPressed;
	uint32_t customColorRightPressed;
	uint32_t customColorB1Pressed;
	uint32_t customColorB2Pressed;
	uint32_t customColorB3Pressed;
	uint32_t customColorB4Pressed;
	uint32_t customColorL1Pressed;
	uint32_t customColorR1Pressed;
	uint32_t customColorL2Pressed;
	uint32_t customColorR2Pressed;
	uint32_t customColorS1Pressed;
	uint32_t customColorS2Pressed;
	uint32_t customColorL3Pressed;
	uint32_t customColorR3Pressed;
	uint32_t customColorA1Pressed;
	uint32_t customColorA2Pressed;
	uint32_t checksum;
};
