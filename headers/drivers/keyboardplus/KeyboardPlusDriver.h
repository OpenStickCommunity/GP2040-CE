...
#ifndef _KEYBOARDPLUS_DRIVER_H_
#define _KEYBOARDPLUS_DRIVER_H_

#include "gpdriver.h"
#include "drivers/keyboardplus/KeyboardPlusDescriptors.h"
#include "eventmanager.h"

class KeyboardPlusDriver : public GPDriver {
public:
...
private:
    ...
    KeyboardPlusKeyReport keyboardReport;
    KeyboardPlusAxisReport axisReport;
    uint8_t last_axis_report[4] = { 0x80, 0x80, 0x80, 0x80 };
    int8_t volumeChange;
};

#endif // _KEYBOARDPLUS_DRIVER_H_
