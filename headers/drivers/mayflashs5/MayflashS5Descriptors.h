...
// Mayflash F300 strings (the S5's documented upstream device).
...
// DualSense identity presented upstream; the PS5 binds the signature to it.
// bMaxPacketSize0 follows CFG_TUD_ENDPOINT0_SIZE (8 with MAYFLASH_S5_EXACT_IDENTITY).
