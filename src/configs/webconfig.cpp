...
std::string setAddonOptions()
{
	...
	addonOptions.i2cInputExpansionSDAPin   = doc["i2cInputExpansionSDAPin"] == -1 ? 0xFF : doc["i2cInputExpansionSDAPin"];
	addonOptions.i2cInputExpansionSCLPin   = doc["i2cInputExpansionSCLPin"] == -1 ? 0xFF : doc["i2cInputExpansionSCLPin"];
	addonOptions.i2cInputExpansionBlock    = doc["i2cInputExpansionBlock"];
	addonOptions.i2cInputExpansionSpeed    = doc["i2cInputExpansionSpeed"];
	addonOptions.i2cInputExpansionAddress  = doc["i2cInputExpansionAddress"];
	strcpy(addonOptions.i2cInputExpansionAnalogMap.data(), (const char*)doc["i2cInputExpansionAnalogMap"]);
	strcpy(addonOptions.i2cInputExpansionDigitalMap.data(), (const char*)doc["i2cInputExpansionDigitalMap"]);
	...
	addonOptions.I2CInputExpansionEnabled = doc["I2CInputExpansionEnabled"];
...
std::string getAddonOptions()
{
	...
	doc["i2cInputExpansionSDAPin"] = addonOptions.i2cInputExpansionSDAPin == 0xFF ? -1 : addonOptions.i2cInputExpansionSDAPin;
	doc["i2cInputExpansionSCLPin"] = addonOptions.i2cInputExpansionSCLPin == 0xFF ? -1 : addonOptions.i2cInputExpansionSCLPin;
	doc["i2cInputExpansionBlock"] = addonOptions.i2cInputExpansionBlock;
	doc["i2cInputExpansionSpeed"] = addonOptions.i2cInputExpansionSpeed;
	doc["i2cInputExpansionAddress"] = addonOptions.i2cInputExpansionAddress;
	doc["i2cInputExpansionAnalogMap"].set(addonOptions.i2cInputExpansionAnalogMap.data());
	doc["i2cInputExpansionDigitalMap"].set(addonOptions.i2cInputExpansionDigitalMap.data());
	...
	doc["I2CInputExpansionEnabled"] = addonOptions.I2CInputExpansionEnabled;
