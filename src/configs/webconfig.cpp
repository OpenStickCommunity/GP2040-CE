...
std::string setAddonOptions()
{
	...
	AnalogModOptions& analogmodOptions = Storage::getInstance().getAddonOptions().analogmodOptions;
	docToPin(analogmodOptions.tilt1Pin, doc, "tilt1Pin");
	docToValue(analogmodOptions.factorTilt1LeftX, doc, "factorTilt1LeftX");
	docToValue(analogmodOptions.factorTilt1LeftY, doc, "factorTilt1LeftY");
	docToValue(analogmodOptions.factorTilt1RightX, doc, "factorTilt1RightX");
	docToValue(analogmodOptions.factorTilt1RightY, doc, "factorTilt1RightY");
	docToPin(analogmodOptions.tilt2Pin, doc, "tilt2Pin");
	docToValue(analogmodOptions.factorTilt2LeftX, doc, "factorTilt2LeftX");
	docToValue(analogmodOptions.factorTilt2LeftY, doc, "factorTilt2LeftY");
	docToValue(analogmodOptions.factorTilt2RightX, doc, "factorTilt2RightX");
	docToValue(analogmodOptions.factorTilt2RightY, doc, "factorTilt2RightY");
	docToPin(analogmodOptions.analogmodLeftAnalogUpPin, doc, "analogmodLeftAnalogUpPin");
	docToPin(analogmodOptions.analogmodLeftAnalogDownPin, doc, "analogmodLeftAnalogDownPin");
	docToPin(analogmodOptions.analogmodLeftAnalogLeftPin, doc, "analogmodLeftAnalogLeftPin");
	docToPin(analogmodOptions.analogmodLeftAnalogRightPin, doc, "analogmodLeftAnalogRightPin");
	docToPin(analogmodOptions.analogmodRightAnalogUpPin, doc, "analogmodRightAnalogUpPin");
...
std::string getAddonOptions()
{
	...
	const AnalogModOptions& analogmodOptions = Storage::getInstance().getAddonOptions().analogmodOptions;
	writeDoc(doc, "tilt1Pin", cleanPin(analogmodOptions.tilt1Pin));
	writeDoc(doc, "factorTilt1LeftX", analogmodOptions.factorTilt1LeftX);
	writeDoc(doc, "factorTilt1LeftY", analogmodOptions.factorTilt1LeftY);
	writeDoc(doc, "factorTilt1RightX", analogmodOptions.factorTilt1RightX);
	writeDoc(doc, "factorTilt1RightY", analogmodOptions.factorTilt1RightY);
	writeDoc(doc, "tilt2Pin", cleanPin(analogmodOptions.tilt2Pin));
	writeDoc(doc, "factorTilt2LeftX", analogmodOptions.factorTilt2LeftX);
	writeDoc(doc, "factorTilt2LeftY", analogmodOptions.factorTilt2LeftY);
	writeDoc(doc, "factorTilt2RightX", analogmodOptions.factorTilt2RightX);
	writeDoc(doc, "factorTilt2RightY", analogmodOptions.factorTilt2RightY);
	writeDoc(doc, "analogmodLeftAnalogUpPin", cleanPin(analogmodOptions.analogmodLeftAnalogUpPin));
	writeDoc(doc, "analogmodLeftAnalogDownPin", cleanPin(analogmodOptions.analogmodLeftAnalogDownPin));
	writeDoc(doc, "analogmodLeftAnalogLeftPin", cleanPin(analogmodOptions.analogmodLeftAnalogLeftPin));
	writeDoc(doc, "analogmodLeftAnalogRightPin", cleanPin(analogmodOptions.analogmodLeftAnalogRightPin));
	writeDoc(doc, "analogmodRightAnalogUpPin", cleanPin(analogmodOptions.analogmodRightAnalogUpPin));
