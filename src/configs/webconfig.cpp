...
std::string setDisplayOptions()
{
	...
	boardOptions.splashDuration        = doc["splashDuration"] == 0 ? SPLASH_DURATION : doc["splashDuration"];
...
std::string getDisplayOptions() // Manually set Document Attributes for the display
{
	...
	doc["splashDuration"]    = boardOptions.splashDuration == SPLASH_DURATION ? 0 : boardOptions.splashDuration;
