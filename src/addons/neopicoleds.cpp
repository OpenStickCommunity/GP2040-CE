...
const std::vector<uint8_t>& NeoPicoLEDAddon::getLEDPositions(string button, const std::vector<std::vector<uint8_t>>& positions)
{
 ...
 */
std::vector<std::vector<Pixel>> NeoPicoLEDAddon::generatedLEDButtons(const std::vector<std::vector<uint8_t>>& positions)
{
 ...
 */
std::vector<std::vector<Pixel>> NeoPicoLEDAddon::generatedLEDStickless(const std::vector<std::vector<uint8_t>>& positions)
{
	std::vector<std::vector<Pixel>> pixels =
	{
		{
 ...
 */
std::vector<std::vector<Pixel>> NeoPicoLEDAddon::generatedLEDWasd(const std::vector<std::vector<uint8_t>>& positions)
{
	std::vector<std::vector<Pixel>> pixels =
	{
		{
 ...
 */
std::vector<std::vector<Pixel>> NeoPicoLEDAddon::generatedLEDWasdFBM(const std::vector<std::vector<uint8_t>>& positions)
{
	std::vector<std::vector<Pixel>> pixels =
	{
		{
...
{
	std::vector<std::vector<uint8_t>> positions(ledButtonCount);
