...
ButtonLayoutScreen::LayoutList ButtonLayoutScreen::drawSunga12keyA()
{
    return BUTTON_LAYOUT_SUNGA12KEYA;
}

ButtonLayoutScreen::LayoutList ButtonLayoutScreen::drawSunga13keyA()
{
    return BUTTON_LAYOUT_SUNGA13KEYA;
}

ButtonLayoutScreen::LayoutList ButtonLayoutScreen::drawSunga14keyLRA()
{
    return BUTTON_LAYOUT_SUNGA14KEYLRA;
}

ButtonLayoutScreen::LayoutList ButtonLayoutScreen::drawSunga14keyUDA()
{
    return BUTTON_LAYOUT_SUNGA14KEYUDA;
}

ButtonLayoutScreen::LayoutList ButtonLayoutScreen::drawSunga17keyA()
{
    return BUTTON_LAYOUT_SUNGA17KEYA;
}

ButtonLayoutScreen::LayoutList ButtonLayoutScreen::drawSunga17keyAAlt()
{
    return BUTTON_LAYOUT_SUNGA17KEYAALT;
}

ButtonLayoutScreen::LayoutList ButtonLayoutScreen::drawSunga18keyA()
{
    return BUTTON_LAYOUT_SUNGA18KEYA;
}

ButtonLayoutScreen::LayoutList ButtonLayoutScreen::drawSunga18keyAAlt()
{
...
ButtonLayoutScreen::LayoutList ButtonLayoutScreen::drawSunga12keyB()
{
    return BUTTON_LAYOUT_SUNGA12KEYB;
}

ButtonLayoutScreen::LayoutList ButtonLayoutScreen::drawSunga13keyB()
{
    return BUTTON_LAYOUT_SUNGA13KEYB;
}

ButtonLayoutScreen::LayoutList ButtonLayoutScreen::drawSunga14keyLRB()
{
    return BUTTON_LAYOUT_SUNGA14KEYLRB;
}

ButtonLayoutScreen::LayoutList ButtonLayoutScreen::drawSunga14keyUDB()
{
