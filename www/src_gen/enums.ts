...
export enum AnimationNonPressedEffects {
    ...
    EFFECT_CHASE_INDEX = 3,
    EFFECT_CHASE_SEQUENTIAL = 4,
    EFFECT_CHASE_CIRCLE_CLOCKWISE = 5,
    EFFECT_CHASE_CIRCLE_ANTICLOCKWISE = 6,
    EFFECT_CHASE_LEFT_TO_RIGHT = 7,
    EFFECT_CHASE_RIGHT_TO_LEFT = 8,
    EFFECT_CHASE_TOP_TO_BOTTOM = 9,
    EFFECT_CHASE_BOTTOM_TO_TOP = 10,
    EFFECT_CHASE_INDEX_PINGPONG = 11,
    EFFECT_CHASE_SEQUENTIAL_PINGPONG = 12,
    EFFECT_CHASE_CIRCLE_PINGPONG = 13,
    EFFECT_CHASE_HORIZONTAL_PINGPONG = 14,
    EFFECT_CHASE_VERTICAL_PINGPONG = 15,
    EFFECT_CHASE_RANDOM = 16,
    EFFECT_JIGGLESTATIC = 17,
    EFFECT_JIGGLETWOSTATICS = 18,
    EFFECT_RAIN = 19
}
