...
export enum AnimationNonPressedEffects {
    ...
    EFFECT_RAIN = 14,
    EFFECT_CHASE_CIRCLE_CLOCKWISE = 15,
    EFFECT_CHASE_CIRCLE_ANTICLOCKWISE = 16,
    EFFECT_CHASE_CIRCLE_PINGPONG = 17,
    EFFECT_CHASE_INDEX = 18,
    EFFECT_CHASE_INDEX_PINGPONG = 19
}
