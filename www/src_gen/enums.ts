...
export enum GamepadHotkey {
    ...
    HOTKEY_LEDS_PRESS_PARAMETER_UP = 54,
    HOTKEY_LEDS_PRESS_PARAMETER_DOWN = 55,
    HOTKEY_LEDS_PARAMETER_UP = 56,
    HOTKEY_LEDS_PARAMETER_DOWN = 57,
    HOTKEY_LEDS_BRIGHTNESS_UP = 58,
    HOTKEY_LEDS_BRIGHTNESS_DOWN = 59,
    HOTKEY_LEDS_SPECIALMOVE_PROFILE_UP = 60,
    HOTKEY_LEDS_SPECIALMOVE_PROFILE_DOWN = 61,
    HOTKEY_LOAD_PROFILE_5 = 62,
    HOTKEY_LOAD_PROFILE_6 = 63,
    HOTKEY_ENABLE_4_WAY_MODE = 64,
    HOTKEY_DISABLE_4_WAY_MODE = 65,
    HOTKEY_TURBO_COUNT_UP = 66,
    HOTKEY_TURBO_COUNT_DOWN = 67,
    HOTKEY_FOCUS_MODE_TOGGLE = 68
}
...
export enum SpecialMoveEffects {
    SMEFFECT_WAVE = 0,
    SMEFFECT_PULSECOLOR = 1,
    SMEFFECT_CIRCLECOLOR = 2,
    SMEFFECT_KNIGHTRIDER = 3,
    SMEFFECT_RANDOMFLASH = 4
}

export enum SpecialMoveInputTypes {
    INPUT_QUARTER_DOWN_RIGHT = 0,
    INPUT_QUARTER_DOWN_LEFT = 1,
    INPUT_DP_RIGHT = 2,
    INPUT_DP_SHORTCUT_RIGHT = 3,
    INPUT_DP_LEFT = 4,
    INPUT_DP_SHORTCUT_LEFT = 5,
    INPUT_HALFCIRCLE_LEFT_RIGHT = 6,
    INPUT_HALFCIRCLE_RIGHT_LEFT = 7,
    INPUT_DOUBLE_DOWN = 8,
    INPUT_DOUBLE_QUARTER_DOWN_RIGHT = 9,
    INPUT_DOUBLE_QUARTER_DOWN_LEFT = 10,
    INPUT_CHARGE_LEFT_RIGHT = 11,
    INPUT_CHARGE_RIGHT_LEFT = 12,
    INPUT_CHARGE_DOWN_UP = 13,
    INPUT_SUPERCHARGE_LEFT_RIGHT = 14,
    INPUT_SUPERCHARGE_RIGHT_LEFT = 15,
    INPUT_360 = 16,
    INPUT_720 = 17,
    INPUT_RAGING_DEMON_RIGHT = 18,
    INPUT_RAGING_DEMON_LEFT = 19,
    INPUT_NONE = 20
}

export enum AnimationNonPressedEffects {
    EFFECT_STATIC_COLOR = 0,
    EFFECT_RAINBOW_SYNCED = 1,
    EFFECT_RAINBOW_ROTATE = 2,
    EFFECT_CHASE_SEQUENTIAL = 3,
    EFFECT_CHASE_LEFT_TO_RIGHT = 4,
    EFFECT_CHASE_RIGHT_TO_LEFT = 5,
    EFFECT_CHASE_TOP_TO_BOTTOM = 6,
    EFFECT_CHASE_BOTTOM_TO_TOP = 7,
    EFFECT_CHASE_SEQUENTIAL_PINGPONG = 8,
    EFFECT_CHASE_HORIZONTAL_PINGPONG = 9,
    EFFECT_CHASE_VERTICAL_PINGPONG = 10,
    EFFECT_CHASE_RANDOM = 11,
    EFFECT_JIGGLESTATIC = 12,
...
export enum AnimationPressedEffects {
    PRESSEDEFFECT_STATIC_COLOR = 0,
    PRESSEDEFFECT_RANDOM = 1,
    PRESSEDEFFECT_JIGGLESTATIC = 2,
    PRESSEDEFFECT_JIGGLETWOSTATICS = 3,
    PRESSEDEFFECT_BURST = 4,
    PRESSEDEFFECT_BURST_RANDOM = 5,
    PRESSEDEFFECT_BURST_SMALL = 6,
    PRESSEDEFFECT_BURST_SMALL_RANDOM = 7
}
