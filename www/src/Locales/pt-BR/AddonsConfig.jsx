export default {
    ...
    'sub-header-text': 'Use o formulário abaixo para reconfigurar as opções de complemento no GP2040-CE.',
    'bootsel-header-text': 'Configuração do Botão BOOTSEL',
    'bootsel-sub-header-text': 'Observação: a tela OLED pode ficar sem resposta se o botão estiver definido; desative para restaurar.',
    ...
    'analog-warning': 'Observação: os analógicos substituirão as entradas do gamepad Left-Stick e Right-Stick quando ativados',
    ...
    'joystick-selection-slider-header-text': 'Controle Deslizante de Seleção de Joystick',
    ...
    'joystick-selection-slider-mode-zero-label': 'Modo Padrão do Pino do Controle Deslizante',
    'joystick-selection-slider-mode-one-label': 'Modo Um do Pino do Controle Deslizante',
    'joystick-selection-slider-mode-two-label': 'Modo Dois do Pino do Controle Deslizante',
	...
	'dual-directional-input-four-way-joystick-mode-label': 'Modo Joystick de 4 Vias Dual Direcional',
	'tilt-header-text': 'Entrada de Inclinação',
	'tilt-1-pin-label': 'Pino 1 de Inclinação',
	'tilt-2-pin-label': 'Pino 2 de Inclinação',
	'tilt-left-analog-up-pin-label': 'Pino de Inclinação Analógica Esquerda para Cima',
	'tilt-left-analog-down-pin-label': 'Pino de Inclinação Analógica Esquerda para Baixo',
	'tilt-left-analog-left-pin-label': 'Pino de Inclinação Analógica Esquerda para a Esquerda',
	'tilt-left-analog-right-pin-label': 'Pino de Inclinação Analógica Esquerda para a Direita',
	'tilt-right-analog-up-pin-label': 'Pino de Inclinação Analógica Direita para Cima',
	'tilt-right-analog-down-pin-label': 'Pino de Inclinação Analógica Direita para Baixo',
	'tilt-right-analog-left-pin-label': 'Pino de Inclinação Analógica Direita para a Esquerda',
	'tilt-right-analog-right-pin-label': 'Pino de Inclinação Analógica Direita para a Direita',
	...
	'player-number-sub-header-text': 'ATENÇÃO: ATIVE ESTA OPÇÃO APENAS SE VOCÊ ESTIVER CONECTANDO VÁRIOS DISPOSITIVOS GP2040-CE COM NÚMERO DE JOGADOR HABILITADO',
	'player-number-label': 'Número do Jogador',
	'socd-cleaning-mode-selection-slider-header-text': 'Controle Deslizante de Seleção de Modo SOCD Cleaning',
	'socd-cleaning-mode-selection-slider-sub-header-text': 'Observação: os modos PS4, PS3 e Nintendo Switch não suportam a configuração SOCD Cleaning como Desligada e usarão o modo SOCD Cleaning Neutro por padrão.',
	'socd-cleaning-mode-selection-slider-mode-default-label': 'Modo de Controle Deslizante SOCD Padrão',
	'socd-cleaning-mode-selection-slider-mode-one-label': 'Modo de Controle Deslizante SOCD Um',
	'socd-cleaning-mode-selection-slider-pin-one-label': 'Pino Um',
	'socd-cleaning-mode-selection-slider-mode-two-label': 'Modo de Controle Deslizante SOCD Dois',
	'socd-cleaning-mode-selection-slider-pin-two-label': 'Pino Dois',
	'ps4-mode-header-text': 'Modo PS4',
	'ps4-mode-sub-header-text': '<0>!!!! AVISO: O GP2040-CE NUNCA FORNECERÁ ESSES ARQUIVOS !!!!</0> <1>Carregue os 3 arquivos necessários e clique no botão "Verificar e Salvar" para usar o Modo PS4.</1>',
	'ps4-mode-private-key-label': 'Chave Privada (PEM)',
	'ps4-mode-serial-number-label': 'Número de Série (16 Bytes em Hexadecimal ASCII)',
	'ps4-mode-signature-label': 'Assinatura (256 Bytes em Binário)',
	'wii-extension-header-text': 'Extensão Wii',
	'wii-extension-sub-header-text': '<0>Observação: se a Tela estiver habilitada ao mesmo tempo, este complemento será desativado.</0> <1>Controladores Atualmente Suportados</1> <0>Classic/Classic Pro: Suporta Ambos os Analógicos e o D-Pad. B = B1, A = B2, Y = B3, X = B4, L = L1, ZL = L2, R = R1, ZR = R2, Menos = S1, Mais = S2, Início = A1</0> <0>Nunchuck: Suporta Stick Analógico. C = B1, Z = B2</0> <0>Guitarra Guitar Hero: Suporta Stick Analógico. Verde = B1, Vermelho = B2, Azul = B3, Amarelo = B4, Laranja = L1, Strum Up = Cima, Strum Down = Baixo, Menos = S1, Mais = S2</0>',
	...
	'keyboard-host-sub-header-text': 'A seguir, defina os pinos de dados +, - e 5V (opcional). Apenas os pinos + e 5V podem ser configurados.',
