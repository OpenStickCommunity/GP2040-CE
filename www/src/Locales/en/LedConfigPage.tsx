export default {
	...
	theme: {
		...
		'non-pressed-context-param-label': 'Non-Pressed Context',
		'pressed-context-param-label': 'Pressed Context',
		'case-context-param-label': 'Case Context',
	...
	animations: {
		...
		NONPRESSED_EFFECT_CHASE_SEQUENTIAL: 'Chase Grid',
		...
		NONPRESSED_EFFECT_CHASE_SEQUENTIAL_PINGPONG: 'Chase Grid Ping Pong',
		...
		NONPRESSED_EFFECT_CHASE_INDEX: 'Chase LedIndex',
		NONPRESSED_EFFECT_CHASE_INDEX_PINGPONG: 'Chase LedIndex Ping Pong',
		...
		PRESSED_EFFECT_BURST_SMALL: 'Small Burst',
	},
};
