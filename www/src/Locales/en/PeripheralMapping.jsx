export default {
    ...
    'usb-description': 'USB Host allows supported USB client devices to be used, such as keyboards, gamepads, or other devices.',
    'peripheral-toggle-unavailable': 'Cannot Enable. Peripheral "{{name}}" unavailable. Enable it in the <0>Peripheral Mapping</0> section.',
    'pin-sda-label': 'SDA',
    'pin-scl-label': 'SCL',
