export default {
	...
	'joystick-selection-slider-ls-pin-label': 'Slider LS Pin',
	'joystick-selection-slider-rs-pin-label': 'Slider RS Pin',
	...
	'ps4-mode-header-text': 'PS4 Mode Authentication',
	'ps4-mode-sub-header-text': '<0>!!!! DISCLAIMER: GP2040-CE WILL NEVER SUPPLY ANY KEYS !!!!</0> <1>Please upload the required key files and click the "Verify & Save" button to enable authentication in PS4 Mode.</1>',
	'ps4-mode-import-mode-label': 'Key file format',
	...
	'ps4-mode-ds4-key-label': 'Full Key Block (1424 Bytes in Binary)',
	'ps4-mode-import-state-busy-text': 'Validating and installing the keys... This should not take more than a few seconds.',
	'ps4-mode-import-state-ok-text': 'Verified and enabled PS4 Mode! Reboot to take effect.',
	'ps4-mode-import-state-unk-err-text': 'Unknown error occurred.',
	'ps4-mode-import-state-err-pre-step-text': 'Error occurred during ',
	'ps4-mode-import-state-err-btwn-step-error-text': ': ',
	'ps4-mode-import-state-err-post-error-text': '. Please double check the key and try again.',
