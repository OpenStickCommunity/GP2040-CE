export default {
	...
	"input-mode-selection-slider-header-text": "Input Mode Selection Slider",
	"input-mode-selection-slider-sub-header-text":
		"Note: Reboots after changing mode. Works with a single slot, two slots or only default slot (override).",
	"input-mode-selection-slider-mode-default-label": "Default Mode",
	"input-mode-selection-slider-mode-one-label": "Slot One",
	"input-mode-selection-slider-pin-one-label": "Pin One",
	"input-mode-selection-slider-mode-two-label": "Slot Two",
	"input-mode-selection-slider-pin-two-label": "Pin Two",
