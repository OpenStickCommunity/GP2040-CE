export default {
	...
	'analog-triggers-header-text': 'Analog Triggers Configuration',
	'analog-triggers-sub-header-text': 'Connect a potentiometer or other analog sensor to a GPIO ADC pin to report L2/R2 as true continuous (0-255) triggers instead of digital on/off buttons.',
	'analog-triggers-left-pin-label': 'Left Trigger (L2) GPIO Pin',
	'analog-triggers-right-pin-label': 'Right Trigger (R2) GPIO Pin',
	'analog-triggers-left-invert-label': 'Invert Left Trigger',
	'analog-triggers-right-invert-label': 'Invert Right Trigger',
	'analog-triggers-inner-deadzone-label': 'Inner Deadzone (%)',
	'analog-triggers-outer-deadzone-label': 'Outer Deadzone (%)',
