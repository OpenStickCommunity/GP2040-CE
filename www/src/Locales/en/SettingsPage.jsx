export default {
	...
	'mayflashs5-mode-text':
		'<span>INFO:</span> Requires a Mayflash S5 connected to the USB host port. For wired play while PS5 Bluetooth is enabled, set PS5 Settings > Accessories > Controller > Communication Method to Use USB Cable. This setting has not yet been verified with this firmware and S5 hardware.',
	'xinput-mode-text':
