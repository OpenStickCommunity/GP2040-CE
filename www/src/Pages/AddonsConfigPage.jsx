		...
		>
			{({ handleSubmit, handleChange, values, errors, setFieldValue }) => (
				<Form noValidate onSubmit={handleSubmit}>
					...
					<Section
						title={t("AddonsConfig:input-mode-selection-slider-header-text")}
					>
						<div
							id="SliderInputModeOptions"
							hidden={!values.SliderInputModeEnabled}
						>
							<Row className="mb-3">
								<p>
									{t(
										"AddonsConfig:input-mode-selection-slider-sub-header-text"
									)}
								</p>
								<FormSelect
									label={t(
										"AddonsConfig:input-mode-selection-slider-mode-default-label"
									)}
									name="sliderInputModeDefault"
									className="form-select-sm"
									groupClassName="col-sm-3 mb-3"
									value={values.sliderInputModeDefault}
									error={errors.sliderInputModeDefault}
									isInvalid={errors.sliderInputModeDefault}
									onChange={handleChange}
								>
									{INPUT_MODES.map((o, i) => (
										<option
											key={`sliderInputModeDefault-option-${i}`}
											value={o.value}
										>
											{o.label}
										</option>
								...
								<FormSelect
									label={t(
										"AddonsConfig:input-mode-selection-slider-mode-one-label"
									)}
									name="sliderInputModeOne"
									className="form-select-sm"
									groupClassName="col-sm-3 mb-3"
									value={values.sliderInputModeOne}
									error={errors.sliderInputModeOne}
									isInvalid={errors.sliderInputModeOne}
									onChange={handleChange}
								>
									{INPUT_MODES.map((o, i) => (
										<option
											key={`sliderInputModeOne-option-${i}`}
											value={o.value}
										>
											{o.label}
										</option>
								...
								<FormControl
									type="number"
									label={t(
										"AddonsConfig:input-mode-selection-slider-pin-one-label"
									)}
									name="pinSliderInputModeOne"
									className="form-select-sm"
									groupClassName="col-sm-1 mb-3"
									value={values.pinSliderInputModeOne}
									error={errors.pinSliderInputModeOne}
									isInvalid={errors.pinSliderInputModeOne}
									onChange={handleChange}
									min={-1}
									max={29}
								/>
								<FormSelect
									label={t(
										"AddonsConfig:input-mode-selection-slider-mode-two-label"
									)}
									name="sliderInputModeTwo"
									className="form-select-sm"
									groupClassName="col-sm-3 mb-3"
									value={values.sliderInputModeTwo}
									error={errors.sliderInputModeTwo}
									isInvalid={errors.sliderInputModeTwo}
									onChange={handleChange}
								>
									{INPUT_MODES.map((o, i) => (
										<option
											key={`sliderInputModeTwo-option-${i}`}
											value={o.value}
										>
											{o.label}
										</option>
								...
								<FormControl
									type="number"
									label={t(
										"AddonsConfig:input-mode-selection-slider-pin-two-label"
									)}
									name="pinSliderInputModeTwo"
									className="form-control-sm"
									groupClassName="col-sm-1 mb-3"
									value={values.pinSliderInputModeTwo}
									error={errors.pinSliderInputModeTwo}
									isInvalid={errors.pinSliderInputModeTwo}
									onChange={handleChange}
									min={-1}
									max={29}
								/>
						...
						<FormCheck
							label={t("Common:switch-enabled")}
							type="switch"
							id="SliderInputModeButton"
							reverse
							isInvalid={false}
							checked={Boolean(values.SliderInputModeEnabled)}
							onChange={(e) => {
								handleCheckbox("SliderInputModeEnabled", values);
								handleChange(e);
							}}
						/>
					</Section>
