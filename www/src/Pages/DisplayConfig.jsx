...
const PIN_PROFILE_INDICATOR_CHOICES = [
	{ label: "None / LEDs", value: 0 }, // NONE
	{ label: "Square, Cross", value: 1 }, // SQUARE_CROSS
	{ label: "Square, Dot", value: 2 }, // SQUARE_DOT
	{ label: "Cross, Dot", value: 3 }, // CROSS_DOT
	{ label: "Dash, Dot", value: 4 }, // DASH_DOT
	{ label: "Circles (Statusbar)", value: 5 }, // CIRCLES_LARGE
	{ label: "Squares (Statusbar)", value: 6 }, // SQUARES_LARGE
];

const PIN_PROFILE_INDICATOR_POSITION_H = [
	{ label: "Left", value: 0 }, // LEFT
	{ label: "Center", value: 1 }, // CENTER
	{ label: "Right", value: 2 }, // RIGHT
];

const PIN_PROFILE_INDICATOR_POSITION_V = [
	{ label: "Statusbar", value: 0 }, // STATUSBAR
	{ label: "Top", value: 1 }, // TOP
	{ label: "Bottom", value: 2 }, // BOTTOM
	{ label: "Offset", value: 3 }, // OFFSET
];

const SOCD_DISPLAY_CHOICES = [
	{ label: "Show Cleaned Result", value: 0 }, // SOCD_DISPLAY_SHOW_CLEANED
	{ label: "Show Raw Input", value: 1 }, // SOCD_DISPLAY_SHOW_RAW
];
...
const FormContext = () => {
	...
	useEffect(() => {
		async function setDisplayOptions() {
			...
			if (!!values.pinProfileIndicatorChoice)
				values.pinProfileIndicatorChoice = parseInt(
					values.pinProfileIndicatorChoice
				);
			if (!!values.pinProfileIndicatorPositionHorizontal)
				values.pinProfileIndicatorPositionHorizontal = parseInt(
					values.pinProfileIndicatorPositionHorizontal
				);
			if (!!values.pinProfileIndicatorPositionVertical)
				values.pinProfileIndicatorPositionVertical = parseInt(
					values.pinProfileIndicatorPositionVertical
				);
			if (!!values.socdDisplayChoice)
				values.socdDisplayChoice = parseInt(values.socdDisplayChoice);
...
export default function DisplayConfigPage() {
	...
	const isPinProfilePositionVerticalOffset = (values) =>
		values.pinProfileIndicatorPositionVertical === 3;
					...
					<Section title={t("DisplayConfig:header-text")}>
						...
						<Form noValidate onSubmit={handleSubmit}>
							...
							<Row className="mb-3">
								...
								<FormSelect
									label={t("DisplayConfig:form.show-socd-cleaning-label")}
									name="socdDisplayChoice"
									className="form-select-sm"
									groupClassName="col-sm-3 mb-3"
									value={values.socdDisplayChoice}
									error={errors.socdDisplayChoice}
									isInvalid={errors.socdDisplayChoice}
									onChange={handleChange}
								>
									{SOCD_DISPLAY_CHOICES.map((o, i) => (
										<option
											key={`socdDisplayChoice-option-${i}`}
											value={o.value}
										>
											{o.label}
										</option>
							...
							<Row className="mb-3">
								<FormSelect
									label={t("DisplayConfig:form.pin-profile-indicator-label")}
									name="pinProfileIndicatorChoice"
									className="form-select-sm"
									groupClassName="col-sm-3 mb-3"
									value={values.pinProfileIndicatorChoice}
									error={errors.pinProfileIndicatorChoice}
									isInvalid={errors.pinProfileIndicatorChoice}
									onChange={handleChange}
								>
									{PIN_PROFILE_INDICATOR_CHOICES.map((o, i) => (
										<option
											key={`pinProfileIndicatorChoice-option-${i}`}
											value={o.value}
										>
											{o.label}
										</option>
								...
								<FormSelect
									label={t(
										"DisplayConfig:form.pin-profile-position-horizontal-label"
									)}
									name="pinProfileIndicatorPositionHorizontal"
									className="form-select-sm"
									groupClassName="col-sm-3 mb-3"
									value={values.pinProfileIndicatorPositionHorizontal}
									error={errors.pinProfileIndicatorPositionHorizontal}
									isInvalid={errors.pinProfileIndicatorPositionHorizontal}
									onChange={handleChange}
								>
									{PIN_PROFILE_INDICATOR_POSITION_H.map((o, i) => (
										<option
											key={`pinProfileIndicatorPositionHorizontal-option-${i}`}
											value={o.value}
										>
											{o.label}
										</option>
								...
								<FormSelect
									label={t(
										"DisplayConfig:form.pin-profile-position-vertical-label"
									)}
									name="pinProfileIndicatorPositionVertical"
									className="form-select-sm"
									groupClassName="col-sm-3 mb-3"
									value={values.pinProfileIndicatorPositionVertical}
									error={errors.pinProfileIndicatorPositionVertical}
									isInvalid={errors.pinProfileIndicatorPositionVertical}
									onChange={handleChange}
								>
									{PIN_PROFILE_INDICATOR_POSITION_V.map((o, i) => (
										<option
											key={`pinProfileIndicatorPositionVertical-option-${i}`}
											value={o.value}
										>
											{o.label}
										</option>
								...
								{isPinProfilePositionVerticalOffset(values) && (
									<FormControl
										type="number"
										label={t(
											"DisplayConfig:form.pin-profile-position-vertical-offset-label"
										)}
										name="pinProfileIndicatorPositionVerticalOffset"
										className="form-select-sm"
										groupClassName="col-sm-3 mb-3"
										value={values.pinProfileIndicatorPositionVerticalOffset}
										error={errors.pinProfileIndicatorPositionVerticalOffset}
										isInvalid={errors.pinProfileIndicatorPositionVerticalOffset}
										onChange={handleChange}
										min={0}
										max={63}
									/>
