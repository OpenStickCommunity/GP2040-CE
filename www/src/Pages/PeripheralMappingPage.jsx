                                            ...
                                            <div key={`peripheral${peripheral.value}block${block.value}`} className="row mb-3">
                                                <div className="col-sm-auto">
                                                    <FormCheck
                                                        ...
                                                        checked={Boolean(values.peripheral[`${block.label}`].enabled)}
                                                        onChange={(e) => {
                                                ...
                                                <div key={`${block.label}.${pin}`} className="col-sm-auto">
                                                    ...
                                                    <FormSelect
                                                        ...
                                                        disabled={!Boolean(values.peripheral[`${block.label}`].enabled)}
                                                        error={getIn(errors,`peripheral.${block.label}.${pin}`)}
                                                        value={values.peripheral[`${block.label}`][`${pin}`]}
                                                        onChange={(e) => {
                                                            setFieldValue(`peripheral.${block.label}.${pin}`, e.target.value);
                                                        }}
                                                    >
                                                ...
                                                <div key={`${block.label}.${option}`} className="col-sm-auto">
                                                    ...
                                                    <FormSelect
                                                        ...
                                                        className="form-select-sm sm-1"
                                                        disabled={!Boolean(values.peripheral[`${block.label}`].enabled)}
                                                        error={getIn(errors,`peripheral.${block.label}.${option}`)}
                                                        value={values.peripheral[`${block.label}`][`${option}`]}
                                                        onChange={(e) => {
                                                            setFieldValue(`peripheral.${block.label}.${option}`, e.target.value);
                                                        }}
                                                    >
