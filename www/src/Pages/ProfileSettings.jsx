...
export default function ProfileOptionsPage() {
	...
	return (
		<Section title={t("ProfileSettings:header-text")}>
			<p>{t("ProfileSettings:pin-profiles-desc")}</p>
			<p>{t("ProfileSettings:pin-profiles-info")}</p>
			<p>{t("ProfileSettings:pin-profiles-layout-label")}</p>
			<pre>
			...
			<Form noValidate validated={validated} onSubmit={handleSubmit}>
				<table className="table table-sm pin-mapping-table text-center">
					<thead>
						<tr>
